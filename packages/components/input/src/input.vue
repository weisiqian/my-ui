...
export default defineComponent({
  ...
  setup(props: InputProps, { emit }) {
    ...
    const inputWrapperStyle = computed(() => {
      ...
      // 应用尺寸
      if (props.size === 'small') {
        style['--input-height'] = theme.Input.heightSmall
        style['--input-font-size'] = theme.Input.fontSizeSmall
      } else if (props.size === 'medium') {
        style['--input-height'] = theme.Input.heightMedium
        style['--input-font-size'] = theme.Input.fontSizeMedium
      } else if (props.size === 'large') {
        style['--input-height'] = theme.Input.heightLarge
        style['--input-font-size'] = theme.Input.fontSizeLarge
      }
      ...
      style['--input-text-color'] = theme.Input.textColor
      style['--input-border-radius'] = theme.Input.borderRadius
